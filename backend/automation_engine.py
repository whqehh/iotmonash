...
Implements:
- Resource Prioritization & Safety Interlocks
- Fan ON if Temperature / Sensor > 300
- Water Pump ON if Soil Moisture < 500
- Warning LED ON if Water Level < 500
- Runaway Pump Watchdog (45s max continuous run)
"""
