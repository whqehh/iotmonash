/**
 * Farm Defense Agency - Dashboard Controller
 * Real-time telemetry, actuator controls, OWASP audit stream, and Chart.js integration.
 */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Set up polling timers for responsive real-time UI
...
/**
 * Fetch and update latest sensor telemetry
 */
...
/**
 * Update Sensor Cards and Gauge Meters
 */
...
/**
 * Manual Toggle Actuator Handler
 */
...
/**
 * Return Actuator to Autonomous Mode
 */
...
/**
 * Immediate Poll Trigger (For Judge Demonstrations)
 */
...
/**
 * Fetch and Render Security Audit Logs
 */
...
/**
 * Chart.js Integration for Live Telemetry Trends
 */
function initChart() {
...
function updateChartData(historyRows) {
  ...
  // Group by timestamp / reading order
  const grouped = {};
  ...
  telemetryChart.update('none'); // fast update without animation glitches
}
